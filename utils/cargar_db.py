...
# Datos de ejemplo
nombres_tutores = [
    ("Carlos", "Rodríguez"), ("María", "López"), ("Jorge", "González"), 
    ("Laura", "Martínez"), ("Roberto", "Sánchez"), ("Ana", "Fernández"),
    ("Diego", "Torres"), ("Paula", "Díaz"), ("Miguel", "Ruiz"),
    ("Lucía", "García"), ("Martín", "Weber"), ("Valentina", "Castro"),
    ("Federico", "Morales"), ("Camila", "Ortiz"), ("Eduardo", "Silva")
]

nombres_mascotas = [
    "Luna", "Max", "Nina", "Zeus", "Lola", "Toby", "Milo", "Coco", 
    "Bella", "Rocky", "Simba", "Nala", "Thor", "Kira", "Oliver"
]
...
with app.app_context():
    ...
    consultas = []
    motivos = [
        "Control anual", "Vacunación", "Malestar general", 
        "Problemas digestivos", "Control post operatorio"
    ]
